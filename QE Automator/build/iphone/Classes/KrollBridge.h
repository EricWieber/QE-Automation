...
@interface QEAutomatorObject : KrollCoverageObject {
#else
@interface QEAutomatorObject : KrollObject {
#endif
@private
...
extern NSString * QEAutomator$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	QEAutomatorObject *_qeautomator;
    KrollObject* console;
	BOOL shutdown;
