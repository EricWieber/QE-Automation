...
//@interface QEAutomatorObject : NSObject
//@end

@interface QEAutomatorObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[QEAutomatorObject class]])
		{
			for (NSString *key in [[(QEAutomatorObject*)o modules] allKeys])
			{
