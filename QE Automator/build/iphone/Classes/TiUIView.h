...
/**
 Base class for all QEAutomator views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the QEAutomator view hierarchy (such as wrapped iOS UIViews) was touched.
