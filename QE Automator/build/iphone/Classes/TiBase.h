...
// in simulator we redefine to format for QEAutomator Developer console
...
{\
	NSString * exceptionName = [@"org.qeautomator." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.qeautomator";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIQEAutomatorNativeItemNone = -1, 
	UIQEAutomatorNativeItemSpinner = -2,
	UIQEAutomatorNativeItemProgressBar = -3,
	
	UIQEAutomatorNativeItemSlider = -4,
	UIQEAutomatorNativeItemSwitch = -5,
	UIQEAutomatorNativeItemMultiButton = -6,
	UIQEAutomatorNativeItemSegmented = -7,
	
	UIQEAutomatorNativeItemTextView = -8,
	UIQEAutomatorNativeItemTextField = -9,
	UIQEAutomatorNativeItemSearchBar = -10,
	
	UIQEAutomatorNativeItemPicker = -11,
	UIQEAutomatorNativeItemDatePicker = -12,
	
	UIQEAutomatorNativeItemInfoLight = -13,
	UIQEAutomatorNativeItemInfoDark = -14,
	
	UIQEAutomatorNativeItemDisclosure = -15,
	
	UIQEAutomatorNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all QEAutomator instances of
