...
// in simulator we redefine to format for QEAHelper Developer console
...
{\
	NSString * exceptionName = [@"org.qeahelper." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.qeahelper";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIQEAHelperNativeItemNone = -1, 
	UIQEAHelperNativeItemSpinner = -2,
	UIQEAHelperNativeItemProgressBar = -3,
	
	UIQEAHelperNativeItemSlider = -4,
	UIQEAHelperNativeItemSwitch = -5,
	UIQEAHelperNativeItemMultiButton = -6,
	UIQEAHelperNativeItemSegmented = -7,
	
	UIQEAHelperNativeItemTextView = -8,
	UIQEAHelperNativeItemTextField = -9,
	UIQEAHelperNativeItemSearchBar = -10,
	
	UIQEAHelperNativeItemPicker = -11,
	UIQEAHelperNativeItemDatePicker = -12,
	
	UIQEAHelperNativeItemInfoLight = -13,
	UIQEAHelperNativeItemInfoDark = -14,
	
	UIQEAHelperNativeItemDisclosure = -15,
	
	UIQEAHelperNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all QEAHelper instances of
