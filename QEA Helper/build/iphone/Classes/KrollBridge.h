...
@interface QEAHelperObject : KrollCoverageObject {
#else
@interface QEAHelperObject : KrollObject {
#endif
@private
...
extern NSString * QEAHelper$ModuleRequireFormat;
