...
/**
 The base class for all QEAHelper modules
 */
...
/**
 QEAHelper Platform calls this method on startup.
 */
-(void)startup;

/**
 QEAHelper Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 QEAHelper Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 QEAHelper Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 QEAHelper Platform calls this method on resume.
 @param sender The sender of the event.
 */
