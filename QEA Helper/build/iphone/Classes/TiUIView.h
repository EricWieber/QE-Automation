...
/**
 Base class for all QEAHelper views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the QEAHelper view hierarchy (such as wrapped iOS UIViews) was touched.
