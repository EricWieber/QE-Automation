...
//@interface QEAHelperObject : NSObject
//@end

@interface QEAHelperObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[QEAHelperObject class]])
		{
			for (NSString *key in [[(QEAHelperObject*)o modules] allKeys])
			{
